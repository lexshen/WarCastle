...
USING_NS_CC;
TutorialMunchQuirk::TutorialMunchQuirk()
{
	COST_MUNCH = 5;
    COST_QUIRK = 10;
}

CCScene* TutorialMunchQuirk::scene()
{
    // 'scene' is an autorelease object
    CCScene *scene = CCScene::create();
    
    // 'layer' is an autorelease object
    TutorialMunchQuirk *layer = TutorialMunchQuirk::create();
