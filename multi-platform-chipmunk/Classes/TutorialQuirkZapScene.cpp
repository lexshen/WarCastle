#include "TutorialQuirkZapScene.h"


USING_NS_CC;

	TutorialQuirkZap::TutorialQuirkZap()
	{
        COST_QUIRK = 5;
        COST_ZAP = 10;

	}
CCScene* TutorialQuirkZap::scene()
{
    // 'scene' is an autorelease object
    CCScene *scene = CCScene::create();
    
    // 'layer' is an autorelease object
    TutorialQuirkZap *layer = TutorialQuirkZap::create();
...
/*
void TutorialQuirkZap::basicSetup()
{
