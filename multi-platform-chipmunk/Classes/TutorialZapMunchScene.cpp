#include "TutorialZapMunchScene.h"


USING_NS_CC;
TutorialZapMunch::TutorialZapMunch()
{
	COST_ZAP = 5;
    COST_MUNCH = 10;
}
CCScene* TutorialZapMunch::scene()
{
    // 'scene' is an autorelease object
    CCScene *scene = CCScene::create();
    
    // 'layer' is an autorelease object
    TutorialZapMunch *layer = TutorialZapMunch::create();
...
/*
void TutorialZapMunch::basicSetup()
{
